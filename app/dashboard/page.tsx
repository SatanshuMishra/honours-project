					...
					<section className="w-full flex-1 flex flex-row justify-between overflow-hidden">
													...
													<div className="p-2 flex-1">
														...
														<div>
															<span className="text-black">
																<i className="ri-book-2-fill text-black pr-2"></i>
																{
																	topic.quizzesCompleted
																}{" "}
																<span
															...
															<span className="text-black">
																<i className="ri-brain-fill text-black px-2"></i>
																?{" "}
																<span
																	style={{
																		display:
						...
						>
							...
							>
								...
								<div className="bg-white rounded-lg flex-1 flex flex-row justify-center items-center text-black">
									{activeTab === 0 && (
